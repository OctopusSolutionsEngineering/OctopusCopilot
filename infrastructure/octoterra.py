...
def get_octoterra_space(query, space_name, project_names, runbook_names, target_names, tenant_names,
    ...
    sanitized_project_names = sanitize_list(project_names, "Project [A-Z]")
    sanitized_tenant_names = sanitize_list(tenant_names, "Tenant [A-Z]")
    sanitized_target_names = sanitize_list(target_names, "Machine [A-Z]")
