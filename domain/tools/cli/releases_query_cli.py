...
from domain.sanitizers.sanitized_list import sanitize_list, get_item_or_none, sanitize_environments, sanitize_tenants
    ...
    def releases_query_callback_implementation(original_query, messages, space, projects, environments, channels,
        ...
        if projects:
            ...
            deployments = timing_wrapper(lambda: get_deployments_for_project(space_id,
                                                                             get_item_or_none(sanitize_list(projects),
                                                                                              0),
                                                                             sanitize_environments(original_query,
                                                                                                   environments),
