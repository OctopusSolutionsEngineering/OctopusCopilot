...
The HCL resource with the labels "octopusdeploy_tenant" and "my_tenant" has an attribute called "name" with the value "My Tenant". This name matches the tenant name in the query. Therefore, this is the tenant we base the answer on.
The HCL resource with the labels "octopusdeploy_channel" and "default" has an attribute called "name" with the value "Default". This name matches the channel name in the query. Therefore, this is the channel we base the answer on.
