...
def cancel_deployment_callback(url, api_key, github_user, connection_string, log_query):
    def cancel_deployment(original_query, space_name=None, project_name=None, release_version=None,
