...
def cancel_runbook_run_callback(url, api_key, github_user, connection_string, log_query):
    def cancel_runbook_run(original_query, space_name=None, project_name=None, runbook_name=None,
        ...
        log_query("cancel_runbook_run", f"""
