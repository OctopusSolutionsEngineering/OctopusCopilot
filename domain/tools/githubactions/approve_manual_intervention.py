...
from infrastructure.octopus import (
    ...
    approve_manual_intervention_for_task,
    get_teams,
)


def approve_manual_intervention_confirm_callback_wrapper(
    github_user, octopus_details, log_query
):
    def approve_manual_intervention_confirm_callback(
        space_id,
        project_name,
        project_id,
        release_version,
        ...
        log_query(
            "approve_manual_intervention_confirm_callback",
            f"""
            Space Id: {space_id}
...
def approve_manual_intervention_callback(
    octopus_details, github_user, connection_string, log_query
):
    def approve_manual_intervention_implementation(
        ...
        log_query(
            "approve_manual_intervention_implementation",
            f"""
