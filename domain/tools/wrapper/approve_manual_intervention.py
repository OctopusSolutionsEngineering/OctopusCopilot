def approve_manual_intervention_wrapper(query, callback, logging):
    def approve_release_to_environment(space_name=None, project_name=None, release_version=None, environment_name=None,
        ...
        """
        return approve_manual_intervention(approve_release_to_environment.__name__, space_name, project_name,
    ...
    def approve_manual_intervention_for_environment(space_name=None, project_name=None, release_version=None,
        ...
        """
        return approve_manual_intervention(approve_manual_intervention_for_environment.__name__, space_name,
                                           project_name, release_version, environment_name, tenant_name, **kwargs)

    def approve_manual_intervention(confirm_callback_function_name=None, space_name=None, project_name=None, release_version=None, environment_name=None,
                                    tenant_name=None, **kwargs):
    ...
    * Approve the manual intervention for 3.17.8 to the Staging environment.
        ...
        if confirm_callback_function_name is None:
            confirm_callback_function_name = approve_manual_intervention.__name__
