def create_account_wrapper(query, callback, logging):
    def create_account(
        ...
        **kwargs,
        ...
        You must only select this function when the prompt is specifically requesting to create a single account.
        You will be penalized for selecting this function for a prompt that asks a general question about accounts.
