...
def find_octopus_variables(filename, label):
    ...
    try:
        ...
        print(
            f'You must include all the following variables from the "Example Octopus {label} Terraform Configuration" at most once unless otherwise specified:'
        )
...
def find_project_scheduled_triggers(filename, label):
    ...
    try:
        ...
        print(
            f'You must include all the following project scheduled trigger resources from the "Example Octopus {label} Terraform Configuration" at most once unless otherwise specified:'
        )
        with open(filename, "r") as file:
...
def find_project_channels(filename, label):
    ...
    try:
        ...
        print(
            f'You must include all the following project channel resources from the "Example Octopus {label} Terraform Configuration" at most once unless otherwise specified:'
        )
        with open(filename, "r") as file:
            lines = file.readlines()
...
def find_lifecycles(filename, label):
    ...
    try:
        ...
        print(
            f'You must include all the following lifecycle resources from the "Example Octopus {label} Terraform Configuration" at most once unless otherwise specified:'
        )
        with open(filename, "r") as file:
            lines = file.readlines()
...
def find_step_names(filename, label):
    try:
        ...
        print(
            f'You must include all the following step resources from the "Example Octopus {label} Terraform Configuration" at most once unless otherwise specified:'
        )
        with open(filename, "r") as file:
            content = file.read()
...
def find_runbook_names(filename, label):
    ...
    try:
        ...
        print(
            "You must include all the following runbook resources at most once unless otherwise specified:"
        )
        with open(filename, "r") as file:
            lines = file.readlines()
    ...
    try:
        ...
        with open(filename, "r") as file:
            ...
            for tf_process_name in runbook_process_tf_names:
                ...
                print(
                    f"\nYou must include all the following runbook steps from the runbook_{runbook_base_name} runbook at most once unless otherwise specified:"
                )
