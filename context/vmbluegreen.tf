...
resource "octopusdeploy_process_step" "process_step_random_quotes__net_iis_check_alternate_prod_deployment" {
  ...
  notes                 = "This step checks to see if a production deployment is being made to the same environment twice in a row. We expect blue/green deployments to alternate between blue and green with each production deployment."
