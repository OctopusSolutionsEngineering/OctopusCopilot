...
resource "octopusdeploy_deployment_process" "deployment_process_every_step_project" {
  ...
  step {
    ...
    action {
      ...
      name                               = "Run a Script"
      notes                              = "An example step that runs an inline script. This step is configured to only run for tenants with the London tenant tag."
      condition                          = "Success"
      run_on_server                      = true
      is_disabled                        = false
  ...
  step {
    ...
    action {
      ...
      name                               = "Run an Azure Script"
      notes                              = "This is an example step that runs an inline script against Azure resources. Note how this step does not defined a primary_package."
      condition                          = "Success"
      run_on_server                      = true
      is_disabled                        = false
      can_be_used_for_project_versioning = true
  ...
  step {
    ...
    action {
      action_type                        = "Octopus.AzurePowerShell"
      name                               = "Run an Azure Script from a package"
      notes                              = "This is an example step that runs a script against Azure resources from a package. Note how this step defines a primary_package."
      condition                          = "Success"
      run_on_server                      = true
      is_disabled                        = false
      can_be_used_for_project_versioning = true
  ...
  step {
    ...
    action {
      ...
      name                               = "Deploy an Azure Web App (Web Deploy)"
      notes                              = "This step deploys an application an an Azure Web App. Note how this step does not define any scripts."
      condition                          = "Success"
      run_on_server                      = true
      is_disabled                        = false
      can_be_used_for_project_versioning = true
