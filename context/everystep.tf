...
data "octopusdeploy_projects" "projecttrigger_every_step_project_scheduled_trigger_with_cron" {
  ids          = null
  partial_name = "Every Step Project"
  skip         = 0
  take         = 1
...
resource "octopusdeploy_project_scheduled_trigger" "projecttrigger_every_step_project_scheduled_trigger_with_cron" {
  count       = "${length(data.octopusdeploy_projects.projecttrigger_every_step_project_scheduled_trigger_with_cron.projects) != 0 ? 0 : 1}"
  space_id    = "${trimspace(var.octopus_space_id)}"
