...
resource "octopusdeploy_channel" "channel_every_step_project_hotfix" {
  ...
  tenant_tags = []
  depends_on  = [octopusdeploy_process_steps_order.process_step_order_every_step_project,octopusdeploy_process_steps_order.process_step_order_every_step_project_example_runbook,octopusdeploy_process_steps_order.process_step_order_every_step_project_runbook_scoped_to_projects_lifecycle_environment]
  lifecycle {
    prevent_destroy = true
  }
}
