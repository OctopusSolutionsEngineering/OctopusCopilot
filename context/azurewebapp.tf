...
resource "octopusdeploy_process_step" "process_step_azure_web_app_manual_intervention_required" {
  count                 = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
...
resource "octopusdeploy_process_templated_step" "process_step_azure_web_app_octopus___check_smtp_server_configured" {
  count                 = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  name                  = "Octopus - Check SMTP Server Configured"
  process_id            = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process.process_azure_web_app[0].id}"
...
resource "octopusdeploy_process_templated_step" "process_step_azure_web_app_scan_for_vulnerabilities" {
  count                 = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  name                  = "Scan for Vulnerabilities"
  process_id            = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process.process_azure_web_app[0].id}"
...
resource "octopusdeploy_process_steps_order" "process_step_order_azure_web_app" {
  count      = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  process_id = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process.process_azure_web_app[0].id}"
  steps      = ["${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_step.process_step_azure_web_app_manual_intervention_required[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_step.process_step_azure_web_app_validate_setup[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_templated_step.process_step_azure_web_app_octopus___check_smtp_server_configured[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_step.process_step_azure_web_app_deploy_azure_web_app_container[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_step.process_step_azure_web_app_smoke_test[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_templated_step.process_step_azure_web_app_scan_for_vulnerabilities[0].id}", "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? null : octopusdeploy_process_step.process_step_azure_web_app_send_deployment_failure_notification[0].id}"]
}
...
resource "octopusdeploy_variable" "azure_web_app_project_octopus_api_key_1" {
  ...
  type            = "Sensitive"
  description     = "This API Key is used to make API calls to the Octopus Server. This value is not set to a valid API key initially and so the value must be configured asfter the project has been created."
  is_sensitive    = true
...
resource "octopusdeploy_variable" "azure_web_app_project_workerpool_1" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
...
resource "octopusdeploy_variable" "azure_web_app_project_randomsuffix_1" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "24a55df428"
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_resourcegroup_name_1" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-development-#{Project.RandomSuffix}"
  name         = "Project.Azure.ResourceGroup.Name"
  type         = "String"
  description  = "The name of the Azure resource group used for the development environment"
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_resourcegroup_name_2" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-test-#{Project.RandomSuffix}"
  name         = "Project.Azure.ResourceGroup.Name"
  type         = "String"
  description  = "The name of the Azure resource group used for the test environment"
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_resourcegroup_name_3" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-production-#{Project.RandomSuffix}"
  name         = "Project.Azure.ResourceGroup.Name"
  type         = "String"
  description  = "The name of the Azure resource group used for the production environment"
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_octopub_name_1" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-webapp-development-#{Project.RandomSuffix}"
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_octopub_name_2" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-webapp-test-#{Project.RandomSuffix}"
  name         = "Project.Azure.WebApp.Octopub.Name"
  type         = "String"
  description  = ""
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_octopub_name_3" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "octopub-webapp-production-#{Project.RandomSuffix}"
  name         = "Project.Azure.WebApp.Octopub.Name"
  type         = "String"
  description  = ""
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_serviceplan_name_1" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "ASP-octopub-webapp-development-#{Project.RandomSuffix}"
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_serviceplan_name_2" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "ASP-octopub-webapp-test-#{Project.RandomSuffix}"
  name         = "Project.Azure.WebApp.ServicePlan.Name"
  type         = "String"
  description  = ""
  is_sensitive = false
...
resource "octopusdeploy_variable" "azure_web_app_project_azure_webapp_serviceplan_name_3" {
  count        = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_azure_web_app.projects) == 0 ?octopusdeploy_project.project_azure_web_app[0].id : data.octopusdeploy_projects.project_azure_web_app.projects[0].id}"
  value        = "ASP-octopub-webapp-production-#{Project.RandomSuffix}"
  name         = "Project.Azure.WebApp.ServicePlan.Name"
  type         = "String"
  description  = ""
  is_sensitive = false
