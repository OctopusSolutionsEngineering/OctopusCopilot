...
data "octopusdeploy_channels" "channel_argo_cd_octopub_default" {
  ids          = []
  partial_name = "Default"
  project_id   = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? data.octopusdeploy_projects.project_argo_cd_octopub.projects[0].id : octopusdeploy_project.project_argo_cd_octopub[0].id}"
  skip         = 0
  take         = 1
}
...
resource "octopusdeploy_process" "process_argo_cd_octopub" {
  count      = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  project_id = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? data.octopusdeploy_projects.project_argo_cd_octopub.projects[0].id : octopusdeploy_project.project_argo_cd_octopub[0].id}"
  depends_on = []
}

resource "octopusdeploy_process_step" "process_step_argo_cd_octopub_approve_production_deployment" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
...
resource "octopusdeploy_process_templated_step" "process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  name                  = "Octopus - Check for Argo CD Instances"
  process_id            = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? null : octopusdeploy_process.process_argo_cd_octopub[0].id}"
  ...
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_approve_production_deployment]
  properties            = {
      }
  execution_properties  = {
        "Octopus.Action.RunOnServer" = "true"
...
resource "octopusdeploy_process_templated_step" "process_step_argo_cd_octopub_octopus___check_smtp_server_configured" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  name                  = "Octopus - Check SMTP Server Configured"
  process_id            = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? null : octopusdeploy_process.process_argo_cd_octopub[0].id}"
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_approve_production_deployment,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances]
  properties            = {
      }
  execution_properties  = {
...
variable "project_argo_cd_octopub_step_update_argo_cd_application_image_tags_package_octopub_frontend_packageid" {
  type        = string
  nullable    = false
  sensitive   = false
  description = "The package ID for the package named octopub-frontend from step Update Argo CD Application Image Tags in project Argo CD Octopub"
  default     = "octopussolutionsengineering/octopub-frontend"
}
resource "octopusdeploy_process_step" "process_step_argo_cd_octopub_update_argo_cd_application_image_tags" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_approve_production_deployment,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_smtp_server_configured]
  properties            = {
      }
  execution_properties  = {
...
resource "octopusdeploy_process_templated_step" "process_step_argo_cd_octopub_scan_for_vulnerabilities" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  name                  = "Scan for Vulnerabilities"
  process_id            = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? null : octopusdeploy_process.process_argo_cd_octopub[0].id}"
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_approve_production_deployment,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_smtp_server_configured,octopusdeploy_process_step.process_step_argo_cd_octopub_update_argo_cd_application_image_tags]
  properties            = {
      }
  execution_properties  = {
        "Octopus.Action.RunOnServer" = "true"
...
resource "octopusdeploy_process_step" "process_step_argo_cd_octopub_send_an_email__deployment_failed_" {
  count                 = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  ...
  package_requirement   = "LetOctopusDecide"
  slug                  = "send-an-email-upon-failure"
  start_trigger         = "StartAfterPrevious"
  tenant_tags           = null
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_approve_production_deployment,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_smtp_server_configured,octopusdeploy_process_step.process_step_argo_cd_octopub_update_argo_cd_application_image_tags,octopusdeploy_process_templated_step.process_step_argo_cd_octopub_scan_for_vulnerabilities]
  properties            = {
...
resource "octopusdeploy_process_steps_order" "process_step_order_argo_cd_octopub" {
  count      = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  process_id = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? null : octopusdeploy_process.process_argo_cd_octopub[0].id}"
...
resource "octopusdeploy_variable" "argo_cd_octopub_project_workerpool_1" {
  count        = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) == 0 ?octopusdeploy_project.project_argo_cd_octopub[0].id : data.octopusdeploy_projects.project_argo_cd_octopub.projects[0].id}"
...
variable "project_argo_cd_octopub_name" {
  type        = string
  nullable    = false
  sensitive   = false
  description = "The name of the project exported from Argo CD Octopub"
  default     = "Argo CD Octopub"
}
variable "project_argo_cd_octopub_description_prefix" {
  type        = string
  nullable    = false
  sensitive   = false
  description = "An optional prefix to add to the project description for the project Argo CD Octopub"
  default     = ""
}
variable "project_argo_cd_octopub_description_suffix" {
  type        = string
  nullable    = false
  sensitive   = false
  description = "An optional suffix to add to the project description for the project Argo CD Octopub"
  default     = ""
}
variable "project_argo_cd_octopub_description" {
  type        = string
  nullable    = false
  sensitive   = false
...
data "octopusdeploy_projects" "project_argo_cd_octopub" {
  ids          = null
  partial_name = "${var.project_argo_cd_octopub_name}"
  skip         = 0
  take         = 1
}
resource "octopusdeploy_project" "project_argo_cd_octopub" {
  count                                = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  name                                 = "${var.project_argo_cd_octopub_name}"
  ...
  tenanted_deployment_participation    = "${var.project_argo_cd_octopub_tenanted}"
  ...
  description = "${var.project_argo_cd_octopub_description_prefix}${var.project_argo_cd_octopub_description}${var.project_argo_cd_octopub_description_suffix}"
  lifecycle {
    prevent_destroy = true
  }
}
resource "octopusdeploy_project_versioning_strategy" "project_argo_cd_octopub" {
  count      = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? 0 : 1}"
  project_id = "${length(data.octopusdeploy_projects.project_argo_cd_octopub.projects) != 0 ? data.octopusdeploy_projects.project_argo_cd_octopub.projects[0].id : octopusdeploy_project.project_argo_cd_octopub[0].id}"
