...
resource "octopusdeploy_process_templated_step" "process_step_argo_cd_octopub_octopus___check_smtp_server_configured" {
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_for_argo_cd_instances]
  properties            = {
      }
  execution_properties  = {
...
resource "octopusdeploy_process_step" "process_step_argo_cd_octopub_update_argo_cd_application_image_tags" {
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_templated_step.process_step_argo_cd_octopub_octopus___check_smtp_server_configured]
  properties            = {
      }
  execution_properties  = {
        "Octopus.Action.RunOnServer" = "true"
...
resource "octopusdeploy_process_templated_step" "process_step_argo_cd_octopub_scan_for_vulnerabilities" {
  ...
  tenant_tags           = null
  worker_pool_variable  = "Project.WorkerPool"
  depends_on            = [octopusdeploy_process_step.process_step_argo_cd_octopub_update_argo_cd_application_image_tags]
  properties            = {
      }
  execution_properties  = {
        "OctopusUseBundledTooling" = "False"
...
resource "octopusdeploy_process_step" "process_step_argo_cd_octopub_send_an_email__deployment_failed_" {
  ...
  start_trigger         = "StartAfterPrevious"
  tenant_tags           = null
  depends_on            = [octopusdeploy_process_templated_step.process_step_argo_cd_octopub_scan_for_vulnerabilities]
  properties            = {
