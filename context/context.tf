...
resource "octopusdeploy_tag" "tagset_tag_set_tag_tag" {
  ...
  count       = length(data.octopusdeploy_tag_sets.tagset_tag_set.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_tag_set.tag_sets[0].tags : item if item.name == "tag"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_tag_set_tag_tag2" {
  ...
  count       = length(data.octopusdeploy_tag_sets.tagset_tag_set.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_tag_set.tag_sets[0].tags : item if item.name == "tag2"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_cities_tag_sydney" {
  ...
  color       = "#333333"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_cities.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_cities.tag_sets[0].tags : item if item.name == "Sydney"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_cities_tag_london" {
  ...
  color       = "#87BFEC"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_cities.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_cities.tag_sets[0].tags : item if item.name == "London"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_cities_tag_washington" {
  ...
  color       = "#5ECD9E"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_cities.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_cities.tag_sets[0].tags : item if item.name == "Washington"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_cities_tag_madrid" {
  ...
  color       = "#FFA461"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_cities.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_cities.tag_sets[0].tags : item if item.name == "Madrid"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_cities_tag_wellington" {
  ...
  color       = "#C5AEEE"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_cities.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_cities.tag_sets[0].tags : item if item.name == "Wellington"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_business_units_tag_billing" {
  ...
  color       = "#333333"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_business_units.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_business_units.tag_sets[0].tags : item if item.name == "Billing"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_business_units_tag_insurance" {
  ...
  color       = "#87BFEC"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_business_units.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_business_units.tag_sets[0].tags : item if item.name == "Insurance"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_business_units_tag_engineering" {
  ...
  color       = "#C5AEEE"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_business_units.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_business_units.tag_sets[0].tags : item if item.name == "Engineering"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_business_units_tag_hr" {
  ...
  color       = "#FFA461"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_business_units.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_business_units.tag_sets[0].tags : item if item.name == "HR"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_regions_tag_us" {
  ...
  color       = "#333333"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_regions.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_regions.tag_sets[0].tags : item if item.name == "US"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_regions_tag_europe" {
  ...
  color       = "#5ECD9E"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_regions.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_regions.tag_sets[0].tags : item if item.name == "Europe"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_regions_tag_asia" {
  ...
  color       = "#FF9F9F"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_regions.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_regions.tag_sets[0].tags : item if item.name == "Asia"]) != 0 ? 0 : 1
}
...
resource "octopusdeploy_tag" "tagset_regions_tag_anz" {
  ...
  color       = "#C5AEEE"
  description = ""
  count       = length(data.octopusdeploy_tag_sets.tagset_regions.tag_sets) != 0 && length([for item in data.octopusdeploy_tag_sets.tagset_regions.tag_sets[0].tags : item if item.name == "ANZ"]) != 0 ? 0 : 1
}
