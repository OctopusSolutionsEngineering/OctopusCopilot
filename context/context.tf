...
data "octopusdeploy_deployment_targets" "target_mock" {
  ids                  = null
  partial_name         = "Mock"
  skip                 = 0
  take                 = 1
...
resource "octopusdeploy_kubernetes_cluster_deployment_target" "target_mock" {
  count                             = "${length(data.octopusdeploy_deployment_targets.target_mock.deployment_targets) != 0 ? 0 : 1}"
  cluster_url                       = "https://mockk8s.octopusdemos.com"
  ...
  container {
    feed_id = "Feeds-5455"
    image   = "octopusdeploy/worker-tools:6.6.5-ubuntu.22.04"
  }
...
data "octopusdeploy_deployment_targets" "target_kubernetes_with_aws_auth" {
  ids                  = null
  partial_name         = "Kubernetes with AWS Auth"
  skip                 = 0
  take                 = 1
  health_statuses      = null
  communication_styles = null
...
resource "octopusdeploy_kubernetes_cluster_deployment_target" "target_kubernetes_with_aws_auth" {
  count                             = "${length(data.octopusdeploy_deployment_targets.target_kubernetes_with_aws_auth.deployment_targets) != 0 ? 0 : 1}"
  cluster_url                       = "https://58D813E1CBA8E17750400B329DD8A8B6.gr7.ap-southeast-2.eks.amazonaws.com"
  environments                      = ["${length(data.octopusdeploy_environments.environment_development.environments) != 0 ? data.octopusdeploy_environments.environment_development.environments[0].id : octopusdeploy_environment.environment_development[0].id}"]
  name                              = "Kubernetes with AWS Auth"
  roles                             = ["Kubernetes"]
  machine_policy_id                 = "${data.octopusdeploy_machine_policies.default_machine_policy.machine_policies[0].id}"
  skip_tls_verification             = true
  tenant_tags                       = []
...
resource "octopusdeploy_kubernetes_cluster_deployment_target" "target_kubernetes_with_token_auth" {
  ...
  environments                      = ["${length(data.octopusdeploy_environments.environment_development.environments) != 0 ? data.octopusdeploy_environments.environment_development.environments[0].id : octopusdeploy_environment.environment_development[0].id}", "${length(data.octopusdeploy_environments.environment_security.environments) != 0 ? data.octopusdeploy_environments.environment_security.environments[0].id : octopusdeploy_environment.environment_security[0].id}", "${length(data.octopusdeploy_parent_environments.parent_environment_features.parent_environments) != 0 ? data.octopusdeploy_parent_environments.parent_environment_features.parent_environments[0].id : octopusdeploy_parent_environment.parent_environment_features[0].id}"]
...
data "octopusdeploy_deployment_freezes" "deploymentfreeze_claims_change_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Claims Change Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_claims_change_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_claims_change_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Claims Change Freeze"
...
data "octopusdeploy_deployment_freezes" "deploymentfreeze_change_window" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Change Window"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_change_window" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_change_window.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Change Window"
  start = "2026-11-01T00:00:00.000+00:00"
  end   = "2026-12-01T23:59:59.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_billing_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Billing Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_billing_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_billing_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Billing Freeze"
  start = "2027-01-01T00:00:00.000+00:00"
  end   = "2027-01-05T23:59:59.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_ledger_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Ledger Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_ledger_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_ledger_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Ledger Freeze"
  start = "2027-03-01T00:00:00.000+00:00"
  end   = "2027-03-08T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_portal_weekend_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Portal Weekend Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_portal_weekend_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_portal_weekend_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Portal Weekend Freeze"
  start = "2027-02-06T00:00:00.000+00:00"
  end   = "2027-02-08T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_year_end_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Year End Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_year_end_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_year_end_freeze.deployment_freezes) != 0 ? 0 : 1}"
...
data "octopusdeploy_deployment_freezes" "deploymentfreeze_booking_blackout" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Booking Blackout"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_booking_blackout" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_booking_blackout.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Booking Blackout"
  start = "2027-04-01T00:00:00.000+00:00"
  end   = "2027-05-01T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_canary_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Canary Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_canary_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_canary_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Canary Freeze"
  start = "2027-06-01T00:00:00.000+00:00"
  end   = "2027-06-02T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_data_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Data Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_data_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_data_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Data Freeze"
  start = "2027-07-01T00:00:00.000+00:00"
  end   = "2027-07-08T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_global_freeze" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Global Freeze"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_global_freeze" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_global_freeze.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Global Freeze"
  start = "2027-08-01T00:00:00.000+00:00"
  end   = "2027-08-03T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}

data "octopusdeploy_deployment_freezes" "deploymentfreeze_ingestor_scope_freeze_4471" {
  ids             = null
  environment_ids = null
  project_ids     = null
  tenant_ids      = null
  partial_name    = "Ingestor Scope Freeze 4471"
  skip            = 0
  take            = 1
}
resource "octopusdeploy_deployment_freeze" "deploymentfreeze_ingestor_scope_freeze_4471" {
  count = "${length(data.octopusdeploy_deployment_freezes.deploymentfreeze_ingestor_scope_freeze_4471.deployment_freezes) != 0 ? 0 : 1}"
  name  = "Ingestor Scope Freeze 4471"
  start = "2027-09-01T00:00:00.000+00:00"
  end   = "2027-09-08T00:00:00.000+00:00"
  lifecycle {
    prevent_destroy = true
  }
}
...
resource "octopusdeploy_variable" "variables_octoai_prompts_project_0__prompt_1" {
  ...
  value        = "Generate a best pratices report"
...
resource "octopusdeploy_variable" "variables_octoai_prompts_project_0__systemprompt_1" {
  count        = "${length(data.octopusdeploy_library_variable_sets.library_variable_set_variables_octoai_prompts.library_variable_sets) != 0 ? 0 : 1}"
  owner_id     = "${length(data.octopusdeploy_library_variable_sets.library_variable_set_variables_octoai_prompts.library_variable_sets) != 0 ? data.octopusdeploy_library_variable_sets.library_variable_set_variables_octoai_prompts.library_variable_sets[0].id : octopusdeploy_library_variable_set.library_variable_set_variables_octoai_prompts[0].id}"
  value        = "This is a general query about the configuration of a project.\n\nGenerate a summary table using emojies to indicate success, failure, or warning, that highlights any aspects of the current project that do not comply with the following instructions:\n\n* All steps using Worker pools must reference the pool from a variable  \n* The following Maven feed must be defined:  \n  * Name: Octopus Maven Feed  \n  * URL: [http://octopus-sales-public-maven-repo.s3-website-ap-southeast-2.amazonaws.com/snapshot](http://octopus-sales-public-maven-repo.s3-website-ap-southeast-2.amazonaws.com/snapshot)  \n* The following Docker feed must be defined:  \n  * Name: GHCR Anonymous  \n  * URL: [https://ghcrfacade-a6awccayfpcpg4cg.eastus-01.azurewebsites.net](https://ghcrfacade-a6awccayfpcpg4cg.eastus-01.azurewebsites.net)  \n* The following environments must be defined:  \n  * Development  \n  * Test  \n  * Production  \n  * Security  \n* The Lifecycle called `DevSecOps` must be defined and use the environments above  \n* Steps that use container images (the “container” block in a “octopusdeploy_process_step” resource) must use [Octopus Labs container images](https://octopushq.atlassian.net/wiki/spaces/SE/pages/2713224189/Octopus+Labs+container+images) (i.e. images starting with `ghcr.io/octopusdeploylabs`) from the GHCR Anonymous feed\n    * Ignore targets when performing this check\n* The project must have a description including instructions on how to recreate it using a prompt, e.g.: `Recreate the project using the prompt: \"Create AWS Lambda project called \"My Lambda Project\"`\n* All script steps (i.e. steps of type `Octopus.Script`) are either community step templates or less than 10 lines of code  \n* Allow deployments to be created when there are no deployment targets  \n* All steps must have descriptions  \n* The project must use  `#{Octopus.Date.Year}.#{Octopus.Date.Month}.#{Octopus.Date.Day}.i` release versioning  \n* Include the steps:   \n  * `Approve Production Deployment`  \n    * Notes: `This step pauses the deployment and waits for approval before continuing.`  \n    * Instructions: `Do you approve the deployment?`  \n    * Scoped to `Production`  \n  * `Octopus - Check SMTP Server Configured`  \n    * Notes: `This step checks that the SMTP server is configured, and if not, provides a link to the documentation.`  \n    * Skips the `Security` environment  \n  * `Send an Email (Deployment Failed)`   \n    * Name: `Send an Email (Deployment failed)`  \n    * This step must only run if this variable is True: `#{if Octopus.Deployment.Error}#{if Octopus.Action[Octopus - Check SMTP Server Configured].Output.SmtpConfigured == \"True\"}true#{/if}#{/if}`  \n    * Notes: `Send an email when the deployment has failed.`  \n    * Skips the `Security` environment  \n  * `Scan for Vulnerabilities`  \n    * Notes: `Scans the SBOM for security vulnerabilities.`  \n  * `Octopus - Check Targets Available`   \n    * Notes: `This step checks that deployment targets are present, and if not, displays a link to the documentation.`  \n    * Steps that require targets must be scoped to the variable `#{Octopus.Action[Octopus - Check Targets Available].Output.SetupValid}`  \n    * Skips the `Security` environment  \n    * This step is only required for projects with steps that deploy to targets. \n    * It is not included for projects without steps that have a target tag. \n    * Projects that deploy to Argo CD will not include this step.\n\nThe steps that perform the application deployment, and that use target tags, will typically be dependent on the output of the `Octopus - Check Targets Available` step. The following run condition must be used:\n\n* `#{unless Octopus.Deployment.Error}#{if Octopus.Action[Octopus - Check Targets Available].Output.SetupValid == \"True\"}true#{/if}#{/unless}`\n\nYou will be penalized for checking if the project has Config-as-Code enabled.\n\nWhen a requirement is not applicable, mark it as compliant."
...
variable "PlatformHubVersionControlUsername" {
  type        = string
  nullable    = false
  sensitive   = true
  description = "The username associated with the platform hub version control settings"
  default     = "c51ccdae-b40f-47b6-a815-09a66cb694fe"
}
variable "PlatformHubVersionControlPassword" {
  type        = string
  nullable    = false
  sensitive   = true
