...
def publish_runbook(space_name, project_name, runbook_name, octopus_server_uri=Octopus_Url,
    ...
    uri = '{0}/api/{1}/runbookprocesses/{2}/runbooksnapshottemplate'.format(octopus_server_uri, space['Id'],
    ...
    for package in runbook_snapshot_template['Packages']:
        uri = '{0}/api/{1}/feeds/{2}/packages/versions?packageId={3}'.format(octopus_server_uri, space['Id'],
                                                                             package['FeedId'], package['PackageId'])
