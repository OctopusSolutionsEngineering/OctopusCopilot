...
def build_mock_test_tools(tool_query):
    ...
    return FunctionDefinitions([
        ...
        FunctionDefinition(
            suggest_solution_wrapper(tool_query, suggest_solution_callback_wrapper(os.environ["TEST_GH_USER"]),
                                     os.environ["GH_TEST_TOKEN"],
                                     get_zendesk_user(),
                                     get_zendesk_token())),
        FunctionDefinition(
            generate_terraform_wrapper(tool_query, generate_terraform_callback_wrapper(), os.environ["GH_TEST_TOKEN"])),
