variable "project_project4_name" {
  type        = string
  nullable    = false
  sensitive   = false
  description = "The name of the project exported from Copilot guided failure"
  default     = "Copilot guided failure"
}
variable "project_project4_description_prefix" {
  type        = string
  nullable    = false
  sensitive   = false
...
variable "project_project4_description_suffix" {
  type        = string
  nullable    = false
  sensitive   = false
...
variable "project_project4_description" {
  type        = string
  nullable    = false
  sensitive   = false
...
variable "project_project4_tenanted" {
  type        = string
  nullable    = false
  sensitive   = false
...
resource "octopusdeploy_project" "project_project4" {
  name                                 = "${var.project_project4_name}"
